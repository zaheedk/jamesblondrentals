...
export const sitemapRoutes: SitemapRoute[] = [
  ...
  { path: '/van-hire-christchurch-airport', priority: 0.85, changefreq: 'weekly' },
  { path: '/van-hire-rolleston', priority: 0.75, changefreq: 'monthly' },
  { path: '/van-hire-rangiora', priority: 0.75, changefreq: 'monthly' },
  ...
  { path: '/cheap-trailer-hire', priority: 0.9, changefreq: 'weekly' },
  ...
  { path: '/car-hire-christchurch-from-uk', priority: 0.9, changefreq: 'weekly' },
  { path: '/car-rental-christchurch-airport', priority: 0.95, changefreq: 'weekly' },
  ...
  { path: '/wedding-minibus-hire', priority: 0.8, changefreq: 'monthly' },
  { path: '/sports-team-minibus-hire', priority: 0.8, changefreq: 'monthly' },
  { path: '/airport-transfer-minibus-hire', priority: 0.8, changefreq: 'monthly' },
  ...
  { path: '/moving-truck-hire-hamilton', priority: 0.9, changefreq: 'weekly' },
  ...
  { path: '/tautliner-hire', priority: 0.9, changefreq: 'weekly' },
  { path: '/moving-truck-rental', priority: 0.9, changefreq: 'weekly' },
  ...
  { path: '/van-hire-porirua', priority: 0.75, changefreq: 'monthly' },
  { path: '/van-hire-kapiti-coast', priority: 0.75, changefreq: 'monthly' },
  { path: '/small-truck-hire-wellington', priority: 0.85, changefreq: 'weekly' },
  { path: '/moving-truck-hire-wellington', priority: 0.85, changefreq: 'weekly' },
  { path: '/furniture-truck-hire-wellington', priority: 0.8, changefreq: 'weekly' },
  { path: '/truck-hire-lower-hutt', priority: 0.85, changefreq: 'monthly' },
  { path: '/truck-hire-porirua', priority: 0.8, changefreq: 'monthly' },
  ...
  { path: '/14-seater-van-hire-auckland', priority: 0.9, changefreq: 'weekly' },
  { path: '/12-seater-van-hire-wellington', priority: 0.95, changefreq: 'weekly' },
