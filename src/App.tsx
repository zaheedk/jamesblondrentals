...
import AucklandAirportCarRentals from "./pages/AucklandAirportCarRentals"; // Import the new Auckland Airport Car Rentals page
...
import RegisterInterestEarn from "./pages/RegisterInterestEarn";
...
import CheapTrailerHire from "./pages/CheapTrailerHire";
import MinibusHireWeddings from "./pages/MinibusHireWeddings";
import MinibusHireSportsTeams from "./pages/MinibusHireSportsTeams";
...
import TautlinerHire from "./pages/TautlinerHire";
import MovingTruckRental from "./pages/MovingTruckRental";
          ...
          <BrowserRouter>
            ...
            <AppLayout>
              <Routes>
                ...
                <Route path="/admin/blog/import" element={
                  <ProtectedRoute>
                    <AdminBlogImport />
                  </ProtectedRoute>
                } />
          ...
          <Route path="/admin/customer-documents" element={
            <ProtectedRoute>
              <AdminCustomerDocuments />
                ...
                <Route path="/earn-from-your-van-or-truck" element={<RegisterInterestEarn />} />
                ...
                <Route path="/pickup-truck-rental" element={<PickupTruckRental />} />
                <Route path="/tipper-truck-hire" element={<TipperTruckHire />} />
                <Route path="/tautliner-hire" element={<TautlinerHire />} />
                <Route path="/moving-truck-rental" element={<MovingTruckRental />} />
                ...
                <Route path="/wedding-minibus-hire" element={<MinibusHireWeddings />} />
                <Route path="/sports-team-minibus-hire" element={<MinibusHireSportsTeams />} />
                <Route path="/airport-transfer-minibus-hire" element={<MinibusAirportTransfers />} />
