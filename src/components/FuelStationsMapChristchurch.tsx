...
const fuelStations = [
  {
    id: 1,
    name: "Allied Fuel",
    position: { lat: -43.484, lng: 172.534 },
    address: "75 Orchard Road, Christchurch Airport"
  },
  {
    id: 2,
    name: "BP",
    position: { lat: -43.483, lng: 172.539 },
    address: "661 Russley Road, Harewood"
  }
];

const FuelStationsMapChristchurch = () => {
...
export default FuelStationsMapChristchurch;
