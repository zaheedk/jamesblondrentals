...
export const christchurchVanPages: ChristchurchVanPage[] = [
  {
    ...
    metaTitle: 'Cargo Van Hire Christchurch from $95/day — Same-Day Pickup',
    metaDescription:
      'Cargo van rental in Christchurch for trades, couriers and small moves. Standard and jumbo cargo vans from $95/day. Drive on a car licence, same-day pickup.',
    eyebrow: 'Christchurch · Cargo Van',
    h1: 'Cargo Van Hire in Christchurch',
    intro:
      'Sliding side door, flat cargo floor, car licence. The cargo van is the everyday workhorse for Christchurch tradies, couriers, e-commerce operators and weekend movers — and ours start from $95/day.',
    heroImage: vanHero,
    ...
    faqs: [
      {
        ...
        answer:
          'Cargo van hire in Christchurch starts from $95 per day plus kilometres. Multi-day, weekly and midweek rates lower the daily price further — check our hot deals page for current discounts.',
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      'Moving van hire in Christchurch for house moves, flat shifts and student moves. Jumbo vans, hand trolleys and straps available. From $95/day, car licence only.',
