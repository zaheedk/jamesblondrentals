...
export const wellingtonVanTruckPages: WellingtonSubPage[] = [
  // ============== VAN SATELLITES ==============
  {
    ...
    kind: 'van',
    metaTitle: 'Cargo Van Hire Wellington from $95/day — Same-Day Pickup',
    metaDescription:
      'Cargo van rental in Wellington for trades, couriers and small moves. Standard and jumbo cargo vans from $95/day. Drive on a car licence, same-day pickup.',
    eyebrow: 'Wellington · Cargo Van',
    h1: 'Cargo Van Hire in Wellington',
    intro:
      'Sliding side door, flat cargo floor, car licence. The cargo van is the everyday workhorse for Wellington tradies, couriers and weekend movers — and ours start from $95/day, picked up from our Te Aro branch.',
    heroImage: vanHero,
    ...
    faqs: [
      {
        ...
        answer:
          'Cargo van hire in Wellington starts from $95 per day plus kilometres. Multi-day, weekly and midweek rates lower the daily price further — see the hot deals page for current discounts.',
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      'Moving van hire in Wellington for house moves, flat shifts and student moves. Jumbo vans, hand trolleys and straps available. From $95/day, car licence only.',
