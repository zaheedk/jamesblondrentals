    ...
    <div className="container mx-auto px-4 py-10">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="prose max-w-none">
            <p className="text-lg mb-4">
              Our 2 Tonne Box Truck (9m³) is the perfect solution for transporting goods, furniture, and equipment with ease. 
              Featuring both automatic and manual transmission options, it offers flexibility and convenience for any job.
            </p>
            <p className="text-lg mb-4">
              With a 3100mm (L) x 1600mm (W) x 1800mm (H) box size and a maximum load capacity of 2000kg, 
              this truck is built to handle medium to heavy-duty transportation needs. Rent one today and 
              enjoy a dependable vehicle for your moving or delivery tasks!
            </p>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-base">Manual & Automatic</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-base">Depending on availability* 42c per km</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-base">3100(L) x 1600(W) x 1800(H)</p>
                  </div>
                </div>
              </div>
            </CardContent>
      ...
      <div className="mt-12">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="space-y-4">
            <div>
              <h3 className="font-bold text-lg">What is the cargo space capacity of the 2 Tonne Box Truck?</h3>
              <p className="text-gray-600">
                The 2 Tonne Box Truck has a cargo space of 9m³, with dimensions of 3100mm (L) x 1600mm (W) x 1800mm (H), making it perfect for medium-sized moves or deliveries.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-lg">Do I need a special license to rent this truck?</h3>
              <p className="text-gray-600">
                No, a standard car license is sufficient to drive our 2 Tonne Box Truck. It's designed to be accessible for all drivers with a valid full license.
              </p>
            </div>
          </div>
          <div className="space-y-4">
            <div>
              <h3 className="font-bold text-lg">Is there a mileage charge for renting this truck?</h3>
              <p className="text-gray-600">
                Yes, there is a mileage charge of 42c per kilometer, depending on availability. Please ask our team for specific details when booking.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-lg">Can I use the 2 Tonne Box Truck for long-distance transport?</h3>
              <p className="text-gray-600">
                Absolutely! This truck is suitable for both local and long-haul trips. Please check with us for any additional requirements for extended rentals.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-12 bg-primary/5 rounded-lg p-6">
        ...
        <p className="text-muted-foreground mb-4">
          The 2 Tonne Box Truck (9m³) is a popular choice for small moves and deliveries across New Zealand. Explore truck hire options in these key locations.
        </p>
...
export default TwoTonneBoxTruckDetail;
