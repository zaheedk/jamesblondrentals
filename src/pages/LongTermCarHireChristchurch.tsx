...
const whoItSuits = [
  ['New to Canterbury', 'Relocating for work or study and not ready to buy — hire monthly while you settle.'],
  ['Between cars', 'A write-off, a long repair or a new car on order: keep driving without buying twice.'],
  ['Business and contractors', 'Project-length hires for staff on Canterbury jobs, with invoicing and vehicle swaps.'],
  ['Long stays and ski seasons', 'A season in Canterbury costs less by the month than stacking daily rates.'],
];
...
const included = [
  ...
  'Pickup from 515 Moorhouse Avenue, Waltham or Christchurch Airport',
  'Cars, SUVs, 7-seaters, vans and utes on the same terms',
];

const LongTermCarHireChristchurch = () => {
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How long is a long-term car hire in Christchurch?',
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'How much does monthly car hire in Christchurch cost?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Monthly rates are quoted on request because they depend on the vehicle class, the length of the hire and the season — ski season is busier. Call 0800 525 663 or send your dates for a quote.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We do. Servicing, WOF, registration and roadside assistance are covered for the length of the hire — you cover fuel and the agreed hire charges.',
        },
      },
      {
        '@type': 'Question',
        name: 'Can I take a long-term hire around the South Island?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes. Long-term hires are used all over the South Island. Confirm your distance allowance at booking, and carry chains if you are driving alpine passes in winter.',
        },
      },
      {
        '@type': 'Question',
        name: 'Where do I collect the car?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'From our central Christchurch branch at 515 Moorhouse Avenue, Waltham — five minutes from Cathedral Square — or arrange a Christchurch Airport collection when you book.',
        },
      },
    ],
  };
  ...
  return (
    <div className="bg-background text-foreground">
      <PageSEO
        title="Long Term Car Hire Christchurch | Monthly Rates | James Blond"
        description="Long-term and monthly car hire in Christchurch. Servicing and roadside assistance included, collect from 515 Moorhouse Avenue or Christchurch Airport."
        canonical="/long-term-car-hire-christchurch"
      />
          ...
          <div className="grid md:grid-cols-12 gap-10 items-end">
            <div className="md:col-span-7">
              <p className="text-sm tracking-[0.25em] uppercase text-muted-foreground mb-6">
                Christchurch · Weekly & monthly hire
              </p>
              <h1 className="font-serif text-5xl md:text-7xl leading-[1.02] tracking-tight">
                Long-term car hire in Christchurch,
                <span className="italic text-primary"> without buying.</span>
              </h1>
              <p className="mt-8 text-lg md:text-xl text-muted-foreground max-w-xl">
                A car for a month, a ski season or the length of a contract — servicing,
                WOF, registration and roadside assistance all on us. Collect on Moorhouse
                Avenue and hand it back when you're done.
              </p>
              <p className="mt-4 text-sm text-muted-foreground max-w-xl">
                Shorter trip?{' '}
                <Link to="/car-hire-christchurch" className="underline hover:text-primary font-medium">See daily car hire in Christchurch</Link>
                {' '}or{' '}
                <Link to="/central-christchurch-car-hire" className="underline hover:text-primary font-medium">our central branch</Link>.
              </p>
            ...
            <div className="md:col-span-5">
              <img
                src={carHero}
                alt="Rental car on a Canterbury road"
      ...
      <section className="container mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="mt-6 text-sm text-muted-foreground">
            Monthly pricing is quoted on request. Daily and weekly car rates are on our{' '}
...
export default LongTermCarHireChristchurch;
