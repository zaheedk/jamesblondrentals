...
const PremiumAWDSUVDetail = () => {
  return (
    <div className="container mx-auto px-4 py-10">
      <PageSEO title="Premium AWD SUV Hire | James Blond Rentals" description="Hire a premium all-wheel-drive SUV for confident driving in all conditions. Ideal for adventure and winter travel." canonical="/fleet/cars/premium-awd-suv" />
      <div className="mb-6">
