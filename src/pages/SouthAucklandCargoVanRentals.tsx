    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl p-6 mb-8">
        <div className="grid md:grid-cols-2 gap-6 items-center">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold mb-4">South Auckland Cargo Van Rentals & Hire</h1>
            <p className="text-lg text-gray-700 mb-6">
              Affordable, reliable cargo vans for hire in South Auckland. Perfect for small moves, deliveries, and business needs throughout South Auckland's diverse communities.
            </p>
          ...
          <div className="relative">
            <img 
              ...
              alt="Cargo Van for Hire in South Auckland" 
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-center">Why Choose James Blond for South Auckland Van Hire?</h2>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-semibold mb-2">Perfect for South Auckland</h3>
                <p className="text-gray-600">Our cargo vans are ideal for navigating South Auckland's industrial areas and residential communities.</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600">All our South Auckland cargo vans are regularly serviced and cleaned, ensuring reliability for your job.</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600">From compact cargo vans to larger options with extra capacity for bigger moves across South Auckland.</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600">Our South Auckland branch provides easy access for pickup and drop-off, serving Manukau, Papakura, and all southern suburbs.</p>
              </div>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="mb-12 bg-gray-50 p-6 rounded-lg">
        <h2 className="text-2xl font-bold mb-6">Popular Cargo Van Options in South Auckland</h2>
          ...
          <TabsContent value="standard">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <img 
                  src="/lovable-uploads/40c4c11d-0a27-40d6-9c5c-3fdbb1c138a0.png" 
                  alt="Standard Cargo Van for South Auckland Hire" 
                ...
                <ul className="list-disc list-inside mb-4 text-gray-600 space-y-1">
                  <li>Perfect for small moves and deliveries around South Auckland</li>
                  <li>Easy to drive and park in local shopping centers and industrial areas</li>
                  <li>Cargo space: 2000(L) x 1400(W) x 1300(H)</li>
                  <li>Fuel-efficient for South Auckland metro driving</li>
                </ul>
              ...
              <div>
                ...
                <ul className="list-disc list-inside mb-4 text-gray-600 space-y-1">
                  ...
                  <li>Ideal for businesses with mobile staff in South Auckland</li>
                </ul>
                <Button asChild variant="outline">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <img 
                  ...
                  alt="Premium Van for South Auckland Business Hire" 
                  className="rounded-lg mb-4"
                  width="500"
                  height="300"
                  loading="lazy"
                ...
                <ul className="list-disc list-inside mb-4 text-gray-600 space-y-1">
                  ...
                  <li>Superior comfort for long delivery days around South Auckland</li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside mb-4 text-gray-600 space-y-1">
                  ...
                  <li>Perfect for larger moves in South Auckland</li>
          ...
          <TabsContent value="specialty">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <img 
                  src="/lovable-uploads/6dde201c-13f3-4671-9e88-6cc1a388d647.png" 
                  alt="Refrigerated Van for South Auckland Food Deliveries" 
                  className="rounded-lg mb-4"
                  width="500"
                  height="300"
                  loading="lazy"
                ...
                <ul className="list-disc list-inside mb-4 text-gray-600 space-y-1">
                  ...
                  <li>Perfect for food deliveries across South Auckland</li>
              ...
              <div>
                <img 
                  src="/lovable-uploads/7924107a-afb6-4c13-aa1d-8dba18465760.png" 
                  alt="Long-term Van Hire South Auckland" 
                  className="rounded-lg mb-4"
                  width="500"
                  height="300"
                  loading="lazy"
                ...
                <ul className="list-disc list-inside mb-4 text-gray-600 space-y-1">
                  <li>Special rates for South Auckland businesses needing extended hire</li>
      ...
      {/* Use Cases Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6">South Auckland Van Hire Solutions</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Courier and delivery services throughout South Auckland suburbs</span>
                </li>
                <li className="flex items-start">
                  ...
                  <span>Retail stock transfers between stores in Manukau, Papakura and beyond</span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <span>Mobile businesses servicing South Auckland homes and businesses</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <span className="bg-primary/20 text-primary font-bold rounded-full w-6 h-6 flex items-center justify-center mr-2 mt-0.5">1</span>
                  <span>Moving between apartments or homes in the southern suburbs</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-primary/20 text-primary font-bold rounded-full w-6 h-6 flex items-center justify-center mr-2 mt-0.5">2</span>
                  <span>Transporting large purchases from South Auckland retailers</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-primary/20 text-primary font-bold rounded-full w-6 h-6 flex items-center justify-center mr-2 mt-0.5">3</span>
                ...
                <li className="flex items-start">
                  <span className="bg-primary/20 text-primary font-bold rounded-full w-6 h-6 flex items-center justify-center mr-2 mt-0.5">4</span>
                  <span>Moving students into South Auckland accommodation</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      {/* South Auckland Specific Info */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6">South Auckland Cargo Van Rental Benefits</h2>
        <div className="grid md:grid-cols-3 gap-6">
          <Card>
            <CardContent className="pt-6">
              <h3 className="font-bold text-xl mb-2">Industrial Area Access</h3>
              <p className="text-gray-600 mb-4">
                South Auckland's industrial zones in Wiri, East Tamaki, and Manukau are easily accessible with our cargo vans. 
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600 mb-4">
                Navigate South Auckland's diverse suburbs with ease. From the residential areas of Papakura to the busy streets of Manukau, 
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600 mb-4">
                Ideal for transport needs between South Auckland and the rest of the Auckland region. 
                Easy access to Southern Motorway means you can efficiently travel to Central Auckland, East Auckland or the Airport.
              </p>
      ...
      <section id="booking" className="mb-12 scroll-mt-16">
        <div className="bg-primary/5 border border-primary/10 rounded-lg p-6">
          <h2 className="text-2xl font-bold mb-6 text-center">Book Your South Auckland Cargo Van</h2>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          <div className="border rounded-lg p-4">
            <h3 className="font-bold mb-2">What license do I need to hire a van in South Auckland?</h3>
          ...
          <div className="border rounded-lg p-4">
            <h3 className="font-bold mb-2">Can I pick up in South Auckland and drop off in another Auckland location?</h3>
            <p className="text-gray-600">
          ...
          <div className="border rounded-lg p-4">
            <h3 className="font-bold mb-2">Are there age restrictions for renting cargo vans in South Auckland?</h3>
            <p className="text-gray-600">
          ...
          <div className="border rounded-lg p-4">
            <h3 className="font-bold mb-2">Do you offer weekend specials for South Auckland van hire?</h3>
            <p className="text-gray-600">
              Yes, we frequently offer weekend specials for South Auckland cargo van rentals. Check our website 
      ...
      <section className="mb-12 text-center">
        <div className="bg-primary p-8 rounded-lg text-white">
          <h2 className="text-2xl font-bold mb-4">Ready to Hire a Van in South Auckland?</h2>
          <p className="mb-6 text-lg">Book now for the best rates and availability across Auckland's southern suburbs!</p>
...
export default SouthAucklandCargoVanRentals;
