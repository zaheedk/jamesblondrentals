...
const AucklandAirportCargoVanRentals = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <PageSEO title="Cargo Van Hire Auckland Airport | James Blond Rentals" description="Rent cargo vans near Auckland Airport for courier work, deliveries and commercial transport. Easy airport pickup." canonical="/auckland-airport-cargo-van-rentals-hire" />
      {/* Hero Section */}
