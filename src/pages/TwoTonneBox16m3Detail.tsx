      ...
      <div className="mt-12 bg-primary text-primary-foreground rounded-xl p-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-6">
          <Button asChild className="bg-white text-primary hover:bg-white/90 font-semibold">
            <Link to="/auckland-truck-rentals?truck=2-tonne-box-16m3#booking">Auckland Truck Hire</Link>
          </Button>
          <Button asChild className="bg-white text-primary hover:bg-white/90 font-semibold">
            <Link to="/west-auckland-truck-rentals?truck=2-tonne-box-16m3#booking">West Auckland</Link>
          </Button>
          <Button asChild className="bg-white text-primary hover:bg-white/90 font-semibold">
            <Link to="/wellington-truck-rentals?truck=2-tonne-box-16m3#booking">Wellington Truck Hire</Link>
          </Button>
          <Button asChild className="bg-white text-primary hover:bg-white/90 font-semibold">
            <Link to="/christchurch-truck-rentals?truck=2-tonne-box-16m3#booking">Christchurch Truck Hire</Link>
          </Button>
          <Button asChild className="bg-white text-primary hover:bg-white/90 font-semibold">
            <Link to="/central-christchurch-truck-hire?truck=2-tonne-box-16m3#booking">Central Christchurch</Link>
          </Button>
          <Button asChild className="bg-white text-primary hover:bg-white/90 font-semibold">
            <Link to="/hamilton-truck-rentals?truck=2-tonne-box-16m3#booking">Hamilton Truck Hire</Link>
          </Button>
        </div>
